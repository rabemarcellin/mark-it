    ...
    variant === 'primary' ? (
      <div>
        <div className="my-4">
          ...
          <h3 className="text-3xl font-bold mb-2">
            ...
            <span className="font-light pr-2">Ariary</span>
          </div>
          <span className="font-light pr-2 text-sm lg:text-base">/ 2.3K personnes touchés</span>
        ...
        <div>
          {[
            ...
            <div key={textLabel} className={`${index % 2 === 0 ? "bg-slate-100" : "bg-white/90"} p-2 text-sm lg:text-base`}>{textLabel}</div>
          ))}
        </div>
      ...
      <div className=" text-white">
        <div className="my-4">
          ...
          <span className="font-light pr-2">/ 2.3K personnes touchés</span>
        ...
        <div>
          {[
            ...
            <div key={textLabel} className={`${index % 2 === 0 ? "backdrop-blur-sm bg-white/20" : "bg-white/10"} p-2 text-sm lg:text-base`}>{textLabel}</div>
          ))}
        </div>
